...
export const escolas = [
  ...
  { id: 'esc-004', nome: 'EMEF Profa. Maria Aparecida Ujio', bairro: 'Porto Novo', endereco: 'Av. Ezequiel da Silva Barreto, 285', status: 'Ativa', dataCadastro: '2026-02-11', x: 73, y: 66 },
  { id: 'esc-005', nome: 'EMEF Profa. Antonia Antunes Arouca', bairro: 'Massaguacu', endereco: 'Rua Italia Baffi Magni, 581', status: 'Ativa', dataCadastro: '2026-02-14', x: 28, y: 24 },
  { id: 'esc-006', nome: 'EMEI/EMEF Prof. Yasutada Nasu', bairro: 'Pereque Mirim', endereco: 'Av. Pedro Goncalves, 685', status: 'Ativa', dataCadastro: '2026-03-01', x: 78, y: 78 },
  { id: 'esc-007', nome: 'EMEF Prof. Luiz Ribeiro Muniz', bairro: 'Martim de Sa', endereco: 'Rua Analandia, 355', status: 'Ativa', dataCadastro: '2026-03-12', x: 39, y: 18 },
  { id: 'esc-008', nome: 'EMEI/EMEF Profa. Alaor Xavier Junqueira', bairro: 'Travessao', endereco: 'Rua Jose Ferreira dos Santos, 381', status: 'Ativa', dataCadastro: '2026-04-02', x: 67, y: 34 },
]
